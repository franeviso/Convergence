...
N = 100000								# number of individuals per guild
E = 100000 								# number of attempted mating events per generation 
G = 10000 								# generations
...
animal.init.p_bits = 896				# average initial 'phenotype' bits set
animal.init.c_bits = 1024				# average initial 'compat' bits set
...
plant.init.p_bits = 128					# average initial 'phenotype' bits set
plant.init.c_bits = 0					# average initial 'compat' bits set
plant.init.n_bits = 0					# average initial 'neutral' bits set

# data output
data.hist_interval = 1					# [generations]; 0: off
data.image_interval = 1000					# [generation] deprecated, 0: off
